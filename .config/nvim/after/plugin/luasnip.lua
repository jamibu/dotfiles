...
ls.add_snippets(
    "markdown",
    {
        ...
        -- TODO: make scheduled a dynamic/snippet node that updates due based on scheduled
        -- TODO: add after option to set due to x days after scheduled
        ls.s("-task", {t "- [ ] ", i(1, "task"), t " #task", i(2)}),
        ls.s("-fulltask", {
            t "- [ ] ", i(1, "task"), t " #task",  t " ", t "📅 ",
            c(2, {
                f(function() return  os.date "%Y-%m-%d" end),
                f(function() return natural_date("due") end)
            }), t " ", t "⏳ ",
            c(3, {
                f(function() return  os.date "%Y-%m-%d" end),
                f(function() return natural_date("due") end)
